...
return [
    ...
    */
    ...
    'from' => [
        'address' => env('MAIL_FROM_ADDRESS', 'efalco@synapse-managers.com'),
        'name' => env('MAIL_FROM_NAME', 'Data Harmony Anonymisation Platform'),
    ],
    ...
    */
    ...
    /* EDF be carfull using the below code.
