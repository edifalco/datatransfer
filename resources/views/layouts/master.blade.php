...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../admin" class="logo">
      ...
      <span class="logo-lg"><b>Data</b>Transfer</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{ Auth::user()->photo ? Auth::user()->photo->file : "/img/place_holder.jpg" }}" class="user-image" alt="User Image">
              <span class="hidden-xs">{{ Auth::user()->name }}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="{{ Auth::user()->photo ? Auth::user()->photo->file : "/img/place_holder.jpg" }}" class="img-circle" alt="User Image">
